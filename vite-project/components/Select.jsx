...
const SelectScrollUpButton = (({ className, ...props }, forwardedRef) => (
...
const SelectScrollDownButton = (({ className, ...props }, forwardedRef) => (
...
const SelectGroupLabel = (({ className, ...props }, forwardedRef) => (
...
const SelectItem = (({ className, children, ...props }, forwardedRef) => {
  return (
...
const SelectSeparator =(({ className, ...props }, forwardedRef) => (
